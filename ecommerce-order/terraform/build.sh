...
BUILDIR="${BUILD_DIR}/ecommerce-demo/ecommerce-order"
...
#INSTALL ecommerce-order
mkdir -p ${BUILDIR}/ecommerce-order/lambda_package
...
pip install -q ${BUILDIR}/ -U -r ${BUILDIR}/aws_requirements.txt -t ${BUILDIR}/lambda_package
    ...
    # sync files
rsync -aP  ${BUILDIR}/ecommerce_order/ ${BUILDIR}/lambda_package/
